...
struct gpio_shortlong_key_platform_data adam_longshortkey_pdata = {
	.gpio = ADAM_KEY_BACK,			/* gpio to use to detect long presses */
...
struct platform_device adam_longshortkey_device = {
	.name	= "gpio-shortlong-kbd",
	.dev	= {
		.platform_data = &adam_longshortkey_pdata,
	},
};

static struct platform_device *adam_pmu_devices[] __initdata = {
	&adam_longshortkey_device,
	&adam_keys_device,
};
